...
void        put_in_bytes()//move this function to the top of the instructions file
{
    char *byte_array;
...
void		apply_sti(t_data *data, t_list *elem, int *param_types, int *params)
{
    ...
    elem->reg_number[params[0]] = put_in_bytes(data, elem. address);//this function puts the desired value onto the required number of bytes in the memory
